#!/usr/bin/env python3
"""
Webots controller: steps BlindHandoffEngine at the simulator clock and mirrors state to ws://127.0.0.1:8765.

Attach to the `blind_handoff_emitter` robot in `worlds/blind_handoff_track2.wbt`.
